...
public class AuthorBlogResourceAssembler implements ResourceAssembler<BlogPost, AuthorBlogResource> {
    ...
    public AuthorBlogResource toResource(BlogPost blog) {
        ...
        resource.setCommentCount(commentPostRepository.countByBlogPost(blog));
        
        resource.add(linkTo(methodOn(AuthorBlogRestController.class).getAuthorBlogPostById(blog.getId()))
                .withSelfRel());
