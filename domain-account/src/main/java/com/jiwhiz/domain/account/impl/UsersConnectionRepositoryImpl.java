...
public class UsersConnectionRepositoryImpl implements UsersConnectionRepository {
    ...
    public UsersConnectionRepositoryImpl(UserSocialConnectionRepository userSocialConnectionRepository, 
    ...
    public List<String> findUserIdsWithConnection(Connection<?> connection) {
        ...
        List<UserSocialConnection> userSocialConnectionList = 
                userSocialConnectionRepository.findByProviderIdAndProviderUserId(key.getProviderId(), key.getProviderUserId());
    ...
    public ConnectionRepository createConnectionRepository(String userId) {
        ...
        return new ConnectionRepositoryImpl(userId, userSocialConnectionRepository, socialAuthenticationServiceLocator, textEncryptor);
    }
}
