...
/**
 * JPA Repository for BlogPost entity.
 * 
 * @author Yuan Ji
 *
 */
public interface BlogPostRepository extends JpaRepository<BlogPost, String> {
    ...
    List<BlogPost> findByPublishedIsTrue();
    
    Page<BlogPost> findByPublishedIsTrueOrderByPublishedTimeDesc(Pageable pageable);

    Page<BlogPost> findByAuthorOrderByCreatedTimeDesc(UserAccount author, Pageable pageable);
