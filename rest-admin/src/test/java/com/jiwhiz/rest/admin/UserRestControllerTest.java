...
public class UserRestControllerTest extends AbstractRestControllerTest {
    ...
    public void getUserAccounts_ShouldReturnAllUserAccounts() throws Exception {
        ...
        mockMvc.perform(get(API_ROOT + URL_ADMIN_USERS))
    ...
    public void getUserAccountById_ShouldReturnUserAccount() throws Exception {
        ...
        mockMvc.perform(get(API_ROOT + URL_ADMIN_USERS_USER, USER_USERNAME))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaTypes.HAL_JSON))
                ...
                .andExpect(jsonPath("$._links.socialConnections.href", endsWith("admin/users/"+USER_USERNAME+"/socialConnections")))
                ;
    }
    ...
    public void updateUserAccount_Lock_ShouldLockUserAccount() throws Exception {
        ...
        mockMvc.perform
                (request(HttpMethod.PATCH, API_ROOT + URL_ADMIN_USERS_USER, USER_USERNAME)
